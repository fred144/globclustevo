...
with plt.rc_context(
    ...
    fs035_interp_points = np.linspace(t_myr_fs035.min(), t_myr_fs035.max(), 1500)
    ...
    fs070_interp_points = np.linspace(t_myr_fs070.min(), t_myr_fs070.max(), 1500)
    ...
    ax[1].plot(fs035_interp_points, sfr_fs035, color="mediumpurple")

    sfr_fs07 = np.gradient(fs070_interp) / 1e6
    ax[1].plot(fs070_interp_points, sfr_fs07, color="coral")
