    ...
    with plt.rc_context(
        ...
        for i, (f7, f3) in enumerate(zip(f7_sn_list, f3_sn_list)):
            ...
            f7_ab_mag = (
                ...
                * np.log10(
                    f7_flux_den_freq,
                    out=np.zeros_like(f7_flux_den_freq),
                    where=(f7_flux_den_freq != 0),
                )
                + 8.9
            )
            ...
            f3_ab_mag = (
                ...
                * np.log10(
                    f3_flux_den_freq,
                    out=np.zeros_like(f3_flux_den_freq),
                    where=(f3_flux_den_freq != 0),
                )
                + 8.9
            )
            ...
            with plt.rc_context(
                ...
                cbar_label = (
                    ...
                    r"$\mathrm{AB \: Magnitude, \lambda = 1500 \: \AA \:}$"
                )
                cbar.set_label(
                    label=cbar_label,
                    # fontsize=10,
