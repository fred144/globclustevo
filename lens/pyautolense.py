# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 13:34:49 2023
...
galaxy_image = al.Array2D.from_fits(file_path=image_path, pixel_scales=0.02)
...
"""
image_plane_grid_2d = al.Grid2D.uniform(shape_native=(200, 200), pixel_scales=0.001)
...
The interpolation works by pairing every ray-traced (y,x) coordinate in the `traced_image_plane_grid_2d` to its
closest 4 coordinates in `source_plane_grid_2d`. 
...
lens_galaxy_plotter = aplt.GalaxyPlotter(galaxy=lens, grid=image_plane_grid_2d)
lens_galaxy_plotter.figures_2d(image=True, deflections_y=True, deflections_x=True)

source_galaxy_plotter = aplt.GalaxyPlotter(galaxy=source, grid=source_plane_grid_2d)
