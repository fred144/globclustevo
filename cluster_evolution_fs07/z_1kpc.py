...
while step <= 227:
    ...
    #---------------------------------------------------------------------------------------------------------
    p.save('/homes/fgarcia4/analysis/cluster_evolution_fs07/sequences/rerun_z_density_1000pc/')
    
    print ('saved frame #' + str(step) + ' to: /homes/fgarcia4/analysis/cluster_evolution_fs07/sequences/rerun_z_density_1000pc/')
