...
for outputNum in range (startSlice, endSlice + 1):
    ...
    p = yt.OffAxisSlicePlot( ds,  faceonVec, "density", center = sp.center, width = (400, "pc"), north_vector = [0,1,0])
    ...
    p.save('/homes/fgarcia4/analysis/cluster_evolution_fs07/sequences/face-on-v2/' + str(outputNum).zfill(3) )

    print('Plot ' + str(outputNum) + 'saved to ' + '/homes/fgarcia4/analysis/cluster_evolution_fs07/sequences/face-on-v2/')
